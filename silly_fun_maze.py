...
class Player(GameSprite):
    ...
    def fire(self):
        bullet = Bullet(mypath + '3.jpg', self.rect.right, self.rect.centery, 15, 20, 15)
        bullets.add(bullet)
...
w3 = GameSprite(mypath + '1.jpg', 500, 300, 50, 400)
w4 = GameSprite(mypath + '1.jpg', 500, 100, 50, 200)
w5 = GameSprite(mypath + '1.jpg', 0, 550, 400, 50)
w6 = GameSprite(mypath + '1.jpg', 100, 400, 400, 0)
w7 = GameSprite(mypath + '1.jpg', 0, 250, 400, 50)
w8 = GameSprite(mypath + '1.jpg', 0, 100, 400, 50)
...
#creating sprites
packman = Player(mypath + '2.jpg', 5, win_height - 80, 80, 80, 0, 0)
final_sprite = GameSprite(mypath + '2.jpg', win_width - 85, win_height - 100, 80, 80)

monster1 = Enemy(mypath + '3.jpg', win_width - 80, 100, 80, 80, randint(15,30))
monster2 = Enemy(mypath + '3.jpg', win_width - 80, 180, 80, 80, randint(15,30))
monster3 = Enemy(mypath + '3.jpg', win_width - 70, 260, 80, 80, randint(15,30))
monster4 = Enemy(mypath + '3.jpg', win_width - 70, 340, 80, 80, randint(15,30))
monster5 = Enemy(mypath + '3.jpg', win_width - 70, 420, 80, 80, randint(15,30))
monster6 = Enemy(mypath + '3.jpg', win_width - 70, 500, 80, 80, randint(15,30))
